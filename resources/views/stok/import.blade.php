<form action="{{ url('/stok/import_ajax') }}" method="POST" id="form-import-stok" 
...
$(document).ready(function() { 
    $("#form-import-stok").validate({ 
        ...
        submitHandler: function(form) {  
            var formData = new FormData(form);  // Ubah form menjadi FormData untuk menangani file 

            $.ajax({ 
                url: form.action, 
                type: form.method, 
                data: formData, 
                processData: false, // Supaya file tidak diubah menjadi string 
                contentType: false, 
